(function (global, factory) {
  ...
  var CardWidget = /*#__PURE__*/ (function () {
    ...
    _proto.collapse = function collapse() {
      ...
      this._element.trigger(
        $__default["default"].Event(EVENT_COLLAPSED),
        this._parent
      );
    };
    ...
    _proto.expand = function expand() {
      ...
      this._element.trigger(
        $__default["default"].Event(EVENT_EXPANDED),
        this._parent
      );
    };
    ...
    _proto.remove = function remove() {
      ...
      this._element.trigger(
        $__default["default"].Event(EVENT_REMOVED),
        this._parent
      );
    };
  ...
  var ControlSidebar = /*#__PURE__*/ (function () {
    ...
    _proto.show = function show() {
      ...
      $__default["default"](this._element).trigger(
        $__default["default"].Event(EVENT_EXPANDED$1)
      );
    };
    ...
    _proto._fixScrollHeight = function _fixScrollHeight() {
      ...
      var navbarFixed =
        ...
        $__default["default"](SELECTOR_HEADER).css("position") === "fixed";
      var footerFixed =
    ...
    _proto._fixHeight = function _fixHeight() {
      ...
      var $controlSidebar = $__default["default"](
        SELECTOR_CONTROL_SIDEBAR + " " + SELECTOR_CONTROL_SIDEBAR_CONTENT
      );
    ...
    ExpandableTable._jQueryInterface = function _jQueryInterface(operation) {
      return this.each(function () {
        ...
        if (
          ...
          operation.match(/init|toggleRow/)
        ) {
          data[operation]();
        }
      });
  ...
  var Fullscreen = /*#__PURE__*/ (function () {
    ...
    Fullscreen._jQueryInterface = function _jQueryInterface(config) {
      ...
      if (
        typeof config === "string" &&
        config.match(/toggle|fullscreen|windowed/)
      ) {
        plugin[config]();
      } else {
        plugin.init();
  ...
  var SELECTOR_TAB_NAVBAR_NAV =
    SELECTOR_DATA_TOGGLE$3 + ".iframe-mode .navbar-nav";
  var SELECTOR_TAB_NAVBAR_NAV_ITEM = SELECTOR_TAB_NAVBAR_NAV + " .nav-item";
  var SELECTOR_TAB_CONTENT =
    SELECTOR_DATA_TOGGLE$3 + ".iframe-mode .tab-content";
  ...
  var IFrame = /*#__PURE__*/ (function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var tabId =
        "panel-" + uniqueName + "-" + Math.floor(Math.random() * 1000);
      var navId = "tab-" + uniqueName + "-" + Math.floor(Math.random() * 1000);
      var newNavItem =
        '<li class="nav-item" role="presentation"><a class="nav-link" data-toggle="row" id="' +
        navId +
        '" href="#' +
        tabId +
    ...
    _proto.openTabSidebar = function openTabSidebar(item, autoOpen) {
      ...
      this.createTab(
        title,
        link,
        link.replace(".html", "").replace("./", "").replaceAll("/", "-"),
        autoOpen
      );
    };
    ...
    _proto.removeActiveTab = function removeActiveTab() {
      ...
      if (
        ...
        $__default["default"](SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING)
          .length
      ) {
        ...
        this.switchTab(
          $navItemParent.children().eq(prevNavItemIndex).find("a")
        );
      }
    };
      ...
      if ($__default["default"]("body").hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
        ...
        if (tabEmpty == true) {
          setTimeout(function () {
            $__default["default"](
              SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING
            ).height(contentWrapperHeight - navbarHeight);
          }, 50);
        } else {
          $__default["default"](SELECTOR_CONTENT_IFRAME).height(
            contentWrapperHeight - navbarHeight
          );
        }
      }
    }; // Static
    ...
    IFrame._jQueryInterface = function _jQueryInterface(operation) {
      ...
      if (
        typeof operation === "string" &&
        operation.match(/createTab|openTabSidebar|switchTab|removeActiveTab/)
      ) {
        var _data;
  ...
  var Layout = /*#__PURE__*/ (function () {
    ...
    _proto.fixLayoutHeight = function fixLayoutHeight(extra) {
      ...
      var heights = {
        window: $__default["default"](window).height(),
        header:
          $__default["default"](SELECTOR_HEADER$1).length !== 0
            ? $__default["default"](SELECTOR_HEADER$1).outerHeight()
            : 0,
        footer:
          $__default["default"](SELECTOR_FOOTER$1).length !== 0
            ? $__default["default"](SELECTOR_FOOTER$1).outerHeight()
            : 0,
        sidebar:
          $__default["default"](SELECTOR_SIDEBAR).length !== 0
            ? $__default["default"](SELECTOR_SIDEBAR).height()
            : 0,
    ...
    _proto._init = function _init() {
      ...
      $__default["default"](SELECTOR_SIDEBAR).on(
  ...
  var PushMenu = /*#__PURE__*/ (function () {
    ...
    _proto.expand = function expand() {
      ...
      $bodySelector
        .addClass(CLASS_NAME_IS_OPENING)
        .removeClass(CLASS_NAME_COLLAPSED$1 + " " + CLASS_NAME_CLOSED)
        .delay(50)
        .queue(function () {
    ...
    _proto.toggle = function toggle() {
      if (
        $__default["default"](SELECTOR_BODY).hasClass(CLASS_NAME_COLLAPSED$1)
      ) {
        this.expand();
      } else {
        this.collapse();
  ...
  $__default["default"](window).on("load", function () {
    PushMenu._jQueryInterface.call(
      $__default["default"](SELECTOR_TOGGLE_BUTTON)
    );
  });
  /**
   * jQuery API
  ...
  var SidebarSearch = /*#__PURE__*/ (function () {
    ...
    _proto.init = function init() {
      ...
      $__default["default"](SELECTOR_SIDEBAR$1)
        .children()
    ...
    _proto.search = function search() {
      ...
      var searchValue = $__default["default"](SELECTOR_SEARCH_INPUT)
        .val()
        .toLowerCase();
      ...
      if (endResults.length === 0) {
        ...
        endResults.each(function (i, result) {
          $__default["default"](SELECTOR_SEARCH_RESULTS_GROUP).append(
            _this2._renderItem(result.name, result.link, result.path)
          );
        });
      }
      ...
      if (this.options.highlightName || this.options.highlightPath) {
        ...
        if (this.options.highlightName) {
          name = name.replace(regExp, function (str) {
            return (
              '<b class="' + _this4.options.highlightClass + '">' + str + "</b>"
            );
          });
        }
    ...
    SidebarSearch._jQueryInterface = function _jQueryInterface(config) {
      ...
      if (
        typeof config === "string" &&
        config.match(/init|toggle|close|open|search/)
      ) {
        plugin[config]();
      } else {
        plugin.init();
  ...
  var Treeview = /*#__PURE__*/ (function () {
    ...
    _proto.init = function init() {
      $__default["default"](
        "" + SELECTOR_LI + SELECTOR_OPEN + " " + SELECTOR_TREEVIEW_MENU
      ).css("display", "block");
